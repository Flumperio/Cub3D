...
/*   Updated: 2021/05/25 11:43:07 by juasanto         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_c3d(t_cube *cub)
{
	...
	cub->tex[5] = (t_tex){"R", NULL, NULL, 0, r_parm};
	cub->tex[6] = (t_tex){"F", NULL, NULL, 0, f_parm};
	cub->tex[7] = (t_tex){"C", NULL, NULL, 0, c_parm};
	cub->tex[8] = (t_tex){"1", NULL, NULL, 0, chk_map};
	cub->tex[9] = (t_tex){"0", NULL, NULL, 0, chk_map};
