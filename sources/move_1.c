...
/*   Updated: 2021/04/30 08:06:02 by juasanto         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_fw(t_cube *cub)
{
	if (cub->wrk_map[(int)(cub->pyr.posX + cub->ray.dirX
			* cub->ray.moveSpeed)][(int)cub->pyr.posY] == 48)
		cub->pyr.posX += cub->ray.dirX * cub->ray.moveSpeed;
	if (cub->wrk_map[(int)cub->pyr.posX][(int)(cub->pyr.posY
		+ cub->ray.dirY * cub->ray.moveSpeed)] == 48)
...
{
	if (cub->wrk_map[(int)(cub->pyr.posX - cub->ray.dirY
			* cub->ray.moveSpeed)][(int)cub->pyr.posY] == 48)
		cub->pyr.posX -= cub->ray.dirY * cub->ray.moveSpeed;
	if (cub->wrk_map[(int)cub->pyr.posX][(int)(cub->pyr.posY
		+ cub->ray.dirX * cub->ray.moveSpeed)] == 48)
